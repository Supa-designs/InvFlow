...
export default function SignUpPage() {
  return (
    <AuthShell
      title="Comienza y prepara tu espacio de trabajo"
      subtitle="Regístrate para crear tu organización y configurar el inventario con el flujo que mejor se adapte a tu negocio."
    >
      <SignUp
        path="/signup"
        routing="path"
